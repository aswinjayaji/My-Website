...
(function(e, t) {
    ...
    (x.Callbacks = function(e) {
        ...
        var n,
            ...
            c = function(t) {
                for (
                    r = e.memory && t, i = !0, a = s || 0, s = 0, o = l.length, n = !0; l && o > a; a++
                )
        ...
        trigger: function(n, r, i, o) {
            ...
            if (
                ...
                if (!o && !p.noBubble && !x.isWindow(i)) {
                    for (
                        c = p.delegateType || g, nt.test(c + g) || (u = u.parentNode); u; u = u.parentNode
                    )
                        h.push(u), (f = u);
                    f === (i.ownerDocument || a) &&
    ...
    x.fn.extend({
        ...
        domManip: function(e, t, n) {
            ...
            if (
                ...
                if (o)
                    for (
                        s = a[a.length - 1].ownerDocument, x.map(a, qt), u = 0; o > u; u++
                    )
                        (i = a[u]),
                        kt.test(i.type || "") &&
    ...
    function Ot(e, t) {
        ...
        if (1 === t.nodeType) {
            if (
                ((n = t.nodeName.toLowerCase()), !x.support.noCloneEvent && t[x.expando])
            ) {
                i = x._data(t);
    ...
    function On(e, t, n, r) {
        ...
        while (o)
            if (
                (e.responseFields[o] && (n[e.responseFields[o]] = t), !l && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)),
                    (l = o),
                    (o = c.shift()))
            )
                if ("*" === o) o = l;
